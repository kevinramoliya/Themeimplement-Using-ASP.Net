...
namespace Themeimplement.Areas.LOC_City.Controllers
{
    [Area("LOC_City")]
    ...
    public class LOC_CityController : Controller
    {
        ...
        public IActionResult LOC_CityDelete(int CityID)
        {
			...
			TempData["City_Delete"] = "Record Deleted Successfully!";
        ...
        public IActionResult Save(LOC_CityModel model)
        {
            ...
            if (model.CityID == null)
            {
				...
				TempData["City_AddEdit"] = "Record Inserted Successfully!";
			}
            else
            {
                objCmd.CommandText = "PR_City_UpdateByPK";
                objCmd.Parameters.AddWithValue("@CityID", model.CityID);
				TempData["City_AddEdit"] = "Record Updated Successfully!";
			}
        ...
        {
            string myconnStr1 = this.Configuration.GetConnectionString("connString");
